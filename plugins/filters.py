    ...
    if (clicked == typed) or (clicked in AUTH_USERS):
        ...
        if query.data.startswith("next"):
            ...
            keyboard = InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("⭕️ JOIN OUR CHANNEL ⭕️", url="https://t.me/joinchat/UlEkHzmhso8hlw8b")]
            ])
            ...
            keyboard = InlineKeyboardMarkup([
              ...
              [InlineKeyboardButton("YOUTUBE LINK", url="https://www.youtube.com/channel/UCe5RaLkqRimYwdWss4FpH2w")]
            ])
